...
var createCache = (t, n) => {
  ...
  let c = o;
  let r;
  const cacheUpdateContextual = (t2, n2) => {
    const o2 = c;
    const l = t2;
    const i = n2 || (s ? !s(o2, l) : o2 !== l);
    if (i || e) {
      c = l;
      r = o2;
    }
  ...
  const cacheUpdateIsolated = (t2) => cacheUpdateContextual(n(c, r), t2);
  const getCurrentCache = (t2) => [c, !!t2, r];
...
var runEachAndClear = (t2, n2, o2) => {
  const runFn = (t3) => t3 ? t3.apply(undefined, n2 || []) : true;
  each(t2, runFn);
  !o2 && (t2.length = 0);
};
var v = "paddingTop";
...
var $t = /* @__PURE__ */ (() => ({
  [Ot]: {
    static: () => (t2, n2, o2) => {
      ...
      const _2 = u2 == null ? undefined : u2.firstChild;
      let d2 = I(r2);
      let f2 = d2;
      let p2 = false;
      let v2;
...
var getPropByPath = (t2, n2) => t2 ? `${n2}`.split(".").reduce((t3, n3) => t3 && hasOwnProperty(t3, n3) ? t3[n3] : undefined, t2) : undefined;
var zt = {
...
var createOptionCheck = (t2, n2, o2) => (s2) => [getPropByPath(t2, s2), o2 || getPropByPath(n2, s2) !== undefined];
var It;
var getNonce = () => It;
var setNonce = (t2) => {
  It = t2;
