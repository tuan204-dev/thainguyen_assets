...
function clampByWordsFromTailwind(el) {
    ...
    const maxLines = clampClass ? parseInt(clampClass.split("line-clamp-")[1], 10) : 3;
    ...
    const computedLineHeight = isNaN(lineHeight) ? parseFloat(style.fontSize) * 1.6 : lineHeight;
