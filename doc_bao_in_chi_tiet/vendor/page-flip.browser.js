!(function (t, e) {
    ...
    class i extends e {
        ...
        draw(t) {
            ...
            for (let t of this.state.area)
                null !== t &&
                    ((t = this.render.convertToGlobal(t)), e.lineTo(t.x - i.x, t.y - i.y));
    ...
    class s {
        ...
        show(t = null) {
            if ((null === t && (t = this.currentPageIndex), t < 0 || t >= this.pages.length))
                return;
    ...
    class a {
        ...
        checkPositionAtCenterLine(t, e, i) {
            ...
            let o = this.rect.bottomRight,
                a = this.rect.topLeft;
            if (
                ("bottom" === this.corner && ((o = this.rect.topRight), (a = this.rect.bottomLeft)),
                o.x <= 0)
            ) {
    ...
    class g {
        ...
        flipToPage(t, e) {
            ...
            try {
                (s > i &&
                    (this.app.getPageCollection().setCurrentSpreadIndex(s - 1), this.flipNext(e)),
                    s < i &&
    ...
    class p {
        constructor(t, e, i) {
            ...
            ((t.style.minWidth = i.minWidth * s + "px"),
                ...
                i.autoSize &&
                    ((t.style.width = "100%"), (t.style.maxWidth = 2 * i.maxWidth + "px")),
    ...
    ((t.PageFlip = class extends (
        class {
            ...
            on(t, e) {
                return (
                    this.events.has(t) ? this.events.get(t).push(e) : this.events.set(t, [e]),
                    this
                );
            }
            off(t) {
