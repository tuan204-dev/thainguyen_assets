...
!(function (e, t) {
    ...
    (p(document)
        ...
        p(window).on(P.LOAD_DATA_API, function () {
            for (
                var e = [].slice.call(document.querySelectorAll(O)), t = 0, n = e.length;
                t < n;
                t++
            ) {
                var i = e[t],
    ...
    (p(document).on(V.CLICK_DATA_API, ae, he._dataApiClickHandler),
        p(window).on(V.LOAD_DATA_API, function () {
            for (
                var e = [].slice.call(document.querySelectorAll(le)), t = 0, n = e.length;
                t < n;
                t++
            ) {
                var i = p(e[t]);
            ...
            return (
                ...
                (o._jQueryInterface = function (n, i) {
                    return this.each(function () {
                        ...
                        if (
                            (e || ((e = new o(this, t)), p(this).data(nn, e)), "string" == typeof n)
                        ) {
                            if ("undefined" == typeof e[n])
                                throw new TypeError('No method named "' + n + '"');
                            e[n](i);
        ...
        Oi = (function () {
            ...
            return (
                ...
                (e._getConfig = function (e) {
                    if (
                        "string" !=
                        typeof (e = l({}, pi, {}, "object" == typeof e && e ? e : {})).target
                    ) {
                ...
                (n._jQueryInterface = function (t) {
                    return this.each(function () {
                        ...
                        if (
                            (e ||
                                ((e = new n(this, "object" == typeof t && t)), p(this).data(ui, e)),
                            "string" == typeof t)
                        ) {
                            if ("undefined" == typeof e[t])
                                throw new TypeError('No method named "' + t + '"');
